        ...
        <div class="container px-4">
            ...
            <div class="row g-4 pb-4 border-bottom border-secondary border-opacity-25">
                <div class="col-lg-5">
                    ...
                    <p class="text-white-50 fs-6 pe-lg-5">
                ...
                <div class="col-md-4 col-lg-3">
                    ...
                    <ul class="list-unstyled d-flex flex-column gap-2">
                        ...
                        <li><a href="about.php" class="text-white-50 text-decoration-none hover-white">Tentang Kami</a></li>
                        <li><a href="program-kerja.php" class="text-white-50 text-decoration-none hover-white">Program Kerja</a></li>
                        <li><a href="berita.php" class="text-white-50 text-decoration-none hover-white">Berita & Artikel</a></li>
                        <li><a href="kontak.php" class="text-white-50 text-decoration-none hover-white">Kontak</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="d-flex flex-column gap-2 text-white-50">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <a href="mailto:himasi@itm.ac.id" class="text-white-50 text-decoration-none">himasi@itm.ac.id</a>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <i class="bi bi-telephone-fill text-white-50"></i>
                            <a href="tel:+628123456789" class="text-white-50 text-decoration-none">+62 812-3456-789</a>
                        </div>
                        <div class="d-flex align-items-start gap-2">
                            <i class="bi bi-geo-alt-fill text-white-50 mt-1"></i>
                            <p class="mb-0">
            ...
            <!-- Bottom Section -->
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3 pt-3 text-white-50 fs-7">
